...
$t08_siswanonrutin = NULL;

//
// Table class for t08_siswanonrutin
//
class ct08_siswanonrutin extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't08_siswanonrutin';
		$this->TableName = 't08_siswanonrutin';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t08_siswanonrutin`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t08_siswanonrutin', 't08_siswanonrutin', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// siswa_id
		$this->siswa_id = new cField('t08_siswanonrutin', 't08_siswanonrutin', 'x_siswa_id', 'siswa_id', '`siswa_id`', '`siswa_id`', 3, -1, FALSE, '`siswa_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nonrutin_id
		$this->nonrutin_id = new cField('t08_siswanonrutin', 't08_siswanonrutin', 'x_nonrutin_id', 'nonrutin_id', '`nonrutin_id`', '`nonrutin_id`', 3, -1, FALSE, '`nonrutin_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Nilai
		$this->Nilai = new cField('t08_siswanonrutin', 't08_siswanonrutin', 'x_Nilai', 'Nilai', '`Nilai`', '`Nilai`', 4, -1, FALSE, '`Nilai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t08_siswanonrutin`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t08_siswanonrutinlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t08_siswanonrutinview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t08_siswanonrutinview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t08_siswanonrutinadd.php?" . $this->UrlParm($parm);
		else
			$url = "t08_siswanonrutinadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t08_siswanonrutinedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t08_siswanonrutinadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t08_siswanonrutindelete.php", $this->UrlParm());
	}
