...
--
-- Host: localhost
-- Generation Time: Oct 23, 2018 at 09:19 PM
...
CREATE TABLE `t06_siswarutinbayar_2` (
  ...
  `siswa_id` int(11) NOT NULL,
  `rutin_id` int(11) NOT NULL,
  `periode_awal` varchar(12) NOT NULL,
  `periode_akhir` varchar(12) NOT NULL,
  `Bayar_Tgl` date DEFAULT NULL,
  `Bayar_Jumlah` float(14,2) DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `t06_siswarutinbayar_2` (`id`, `siswa_id`, `rutin_id`, `periode_awal`, `periode_akhir`, `Bayar_Tgl`, `Bayar_Jumlah`) VALUES
(1, 5, 1, '0', '0', NULL, 0.00),
(2, 5, 2, '0', '0', NULL, 0.00),
(3, 6, 1, '0', '0', NULL, 0.00),
(4, 6, 2, '0', '0', NULL, 0.00),
