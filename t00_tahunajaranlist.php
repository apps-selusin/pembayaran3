...
// Validate form
ft00_tahunajaranlist.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t00_tahunajaran->Tahun_Ajaran->FldCaption(), $t00_tahunajaran->Tahun_Ajaran->ReqErrMsg)) ?>");
...
<?php if ($t00_tahunajaran->Akhir_Tahun->Visible) { // Akhir_Tahun ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($t00_tahunajaran->Tahun_Ajaran->Visible) { // Tahun_Ajaran ?>
	<?php if ($t00_tahunajaran->SortUrl($t00_tahunajaran->Tahun_Ajaran) == "") { ?>
		<th data-name="Tahun_Ajaran"><div id="elh_t00_tahunajaran_Tahun_Ajaran" class="t00_tahunajaran_Tahun_Ajaran"><div class="ewTableHeaderCaption"><?php echo $t00_tahunajaran->Tahun_Ajaran->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Tahun_Ajaran"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t00_tahunajaran->SortUrl($t00_tahunajaran->Tahun_Ajaran) ?>',2);"><div id="elh_t00_tahunajaran_Tahun_Ajaran" class="t00_tahunajaran_Tahun_Ajaran">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t00_tahunajaran->Tahun_Ajaran->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t00_tahunajaran->Tahun_Ajaran->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t00_tahunajaran->Tahun_Ajaran->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($t00_tahunajaran_list->FormKeyCountName) && ($t00_tahunajaran->CurrentAction == "gridadd" || $t00_tahunajaran->CurrentAction == "gridedit" || $t00_tahunajaran->CurrentAction == "F")) {
		$t00_tahunajaran_list->KeyCount = $objForm->GetValue($t00_tahunajaran_list->FormKeyCountName);
		$t00_tahunajaran_list->StopRec = $t00_tahunajaran_list->StartRec + $t00_tahunajaran_list->KeyCount - 1;
	}
}
...
$t00_tahunajaran_list->EditRowCnt = 0;
if ($t00_tahunajaran->CurrentAction == "edit")
	$t00_tahunajaran_list->RowIndex = 1;
while ($t00_tahunajaran_list->RecCnt < $t00_tahunajaran_list->StopRec) {
	...
	if (intval($t00_tahunajaran_list->RecCnt) >= intval($t00_tahunajaran_list->StartRec)) {
		...
		if ($t00_tahunajaran->CurrentAction == "gridadd") {
			$t00_tahunajaran_list->LoadDefaultValues(); // Load default values
		} else {
		...
		if ($t00_tahunajaran->CurrentAction == "edit") {
			if ($t00_tahunajaran_list->CheckInlineEditKey() && $t00_tahunajaran_list->EditRowCnt == 0) { // Inline edit
				$t00_tahunajaran->RowType = EW_ROWTYPE_EDIT; // Render edit
			}
		}
		if ($t00_tahunajaran->CurrentAction == "edit" && $t00_tahunajaran->RowType == EW_ROWTYPE_EDIT && $t00_tahunajaran->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$t00_tahunajaran_list->RestoreFormValues(); // Restore form values
		}
		if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) // Edit row
			$t00_tahunajaran_list->EditRowCnt++;
...
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Awal_Bulan" class="form-group t00_tahunajaran_Awal_Bulan">
<select data-table="t00_tahunajaran" data-field="x_Awal_Bulan" data-value-separator="<?php echo $t00_tahunajaran->Awal_Bulan->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Awal_Bulan" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Awal_Bulan"<?php echo $t00_tahunajaran->Awal_Bulan->EditAttributes() ?>>
<?php echo $t00_tahunajaran->Awal_Bulan->SelectOptionListHtml("x<?php echo $t00_tahunajaran_list->RowIndex ?>_Awal_Bulan") ?>
</select>
</span>
<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<a id="<?php echo $t00_tahunajaran_list->PageObjName . "_row_" . $t00_tahunajaran_list->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT || $t00_tahunajaran->CurrentMode == "edit") { ?>
<input type="hidden" data-table="t00_tahunajaran" data-field="x_id" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_id" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($t00_tahunajaran->id->CurrentValue) ?>">
<?php } ?>
	<?php if ($t00_tahunajaran->Awal_Tahun->Visible) { // Awal_Tahun ?>
		<td data-name="Awal_Tahun"<?php echo $t00_tahunajaran->Awal_Tahun->CellAttributes() ?>>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Awal_Tahun" class="form-group t00_tahunajaran_Awal_Tahun">
<input type="text" data-table="t00_tahunajaran" data-field="x_Awal_Tahun" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Awal_Tahun" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Awal_Tahun" size="30" placeholder="<?php echo ew_HtmlEncode($t00_tahunajaran->Awal_Tahun->getPlaceHolder()) ?>" value="<?php echo $t00_tahunajaran->Awal_Tahun->EditValue ?>"<?php echo $t00_tahunajaran->Awal_Tahun->EditAttributes() ?>>
</span>
<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Akhir_Bulan" class="form-group t00_tahunajaran_Akhir_Bulan">
<select data-table="t00_tahunajaran" data-field="x_Akhir_Bulan" data-value-separator="<?php echo $t00_tahunajaran->Akhir_Bulan->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Akhir_Bulan" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Akhir_Bulan"<?php echo $t00_tahunajaran->Akhir_Bulan->EditAttributes() ?>>
<?php echo $t00_tahunajaran->Akhir_Bulan->SelectOptionListHtml("x<?php echo $t00_tahunajaran_list->RowIndex ?>_Akhir_Bulan") ?>
</select>
</span>
<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Akhir_Tahun" class="form-group t00_tahunajaran_Akhir_Tahun">
<input type="text" data-table="t00_tahunajaran" data-field="x_Akhir_Tahun" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Akhir_Tahun" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Akhir_Tahun" size="30" placeholder="<?php echo ew_HtmlEncode($t00_tahunajaran->Akhir_Tahun->getPlaceHolder()) ?>" value="<?php echo $t00_tahunajaran->Akhir_Tahun->EditValue ?>"<?php echo $t00_tahunajaran->Akhir_Tahun->EditAttributes() ?>>
</span>
<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($t00_tahunajaran->Tahun_Ajaran->Visible) { // Tahun_Ajaran ?>
		<td data-name="Tahun_Ajaran"<?php echo $t00_tahunajaran->Tahun_Ajaran->CellAttributes() ?>>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Tahun_Ajaran" class="form-group t00_tahunajaran_Tahun_Ajaran">
<span<?php echo $t00_tahunajaran->Tahun_Ajaran->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t00_tahunajaran->Tahun_Ajaran->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t00_tahunajaran" data-field="x_Tahun_Ajaran" name="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Tahun_Ajaran" id="x<?php echo $t00_tahunajaran_list->RowIndex ?>_Tahun_Ajaran" value="<?php echo ew_HtmlEncode($t00_tahunajaran->Tahun_Ajaran->CurrentValue) ?>">
<?php } ?>
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $t00_tahunajaran_list->RowCnt ?>_t00_tahunajaran_Tahun_Ajaran" class="t00_tahunajaran_Tahun_Ajaran">
<span<?php echo $t00_tahunajaran->Tahun_Ajaran->ViewAttributes() ?>>
<?php echo $t00_tahunajaran->Tahun_Ajaran->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($t00_tahunajaran->RowType == EW_ROWTYPE_ADD || $t00_tahunajaran->RowType == EW_ROWTYPE_EDIT) { ?>
<script type="text/javascript">
ft00_tahunajaranlist.UpdateOpts(<?php echo $t00_tahunajaran_list->RowIndex ?>);
</script>
<?php } ?>
<?php
	}
...
<?php } ?>
<?php if ($t00_tahunajaran->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $t00_tahunajaran_list->FormKeyCountName ?>" id="<?php echo $t00_tahunajaran_list->FormKeyCountName ?>" value="<?php echo $t00_tahunajaran_list->KeyCount ?>">
<?php } ?>
