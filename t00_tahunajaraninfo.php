...
class ct00_tahunajaran extends cTable {
	...
	function __construct() {
		...
		// Tahun_Ajaran
		$this->Tahun_Ajaran = new cField('t00_tahunajaran', 't00_tahunajaran', 'x_Tahun_Ajaran', 'Tahun_Ajaran', '`Tahun_Ajaran`', '`Tahun_Ajaran`', 200, -1, FALSE, '`Tahun_Ajaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		//echo "Row Inserted"
		$q = "update t00_tahunajaran set
			Tahun_Ajaran = '".$rsnew["Awal_Tahun"]." / ".
			$rsnew["Akhir_Tahun"]."'
			where id = ".$rsnew["id"]."
		";
		ew_Execute($q);
