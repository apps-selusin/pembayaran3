...
class ct01_sekolah extends cTable {
	...
	function __construct() {
		...
		// NoTelpHp
		$this->NoTelpHp = new cField('t01_sekolah', 't01_sekolah', 'x_NoTelpHp', 'NoTelpHp', '`NoTelpHp`', '`NoTelpHp`', 200, -1, FALSE, '`NoTelpHp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoTelpHp->Sortable = TRUE; // Allow sort
		$this->fields['NoTelpHp'] = &$this->NoTelpHp;

		// TTD1Nama
		$this->TTD1Nama = new cField('t01_sekolah', 't01_sekolah', 'x_TTD1Nama', 'TTD1Nama', '`TTD1Nama`', '`TTD1Nama`', 200, -1, FALSE, '`TTD1Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TTD1Nama->Sortable = TRUE; // Allow sort
		$this->fields['TTD1Nama'] = &$this->TTD1Nama;

		// TTD1Jabatan
		$this->TTD1Jabatan = new cField('t01_sekolah', 't01_sekolah', 'x_TTD1Jabatan', 'TTD1Jabatan', '`TTD1Jabatan`', '`TTD1Jabatan`', 200, -1, FALSE, '`TTD1Jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TTD1Jabatan->Sortable = TRUE; // Allow sort
		$this->fields['TTD1Jabatan'] = &$this->TTD1Jabatan;

		// TTD2Nama
		$this->TTD2Nama = new cField('t01_sekolah', 't01_sekolah', 'x_TTD2Nama', 'TTD2Nama', '`TTD2Nama`', '`TTD2Nama`', 200, -1, FALSE, '`TTD2Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TTD2Nama->Sortable = TRUE; // Allow sort
		$this->fields['TTD2Nama'] = &$this->TTD2Nama;

		// TTD2Jabatan
		$this->TTD2Jabatan = new cField('t01_sekolah', 't01_sekolah', 'x_TTD2Jabatan', 'TTD2Jabatan', '`TTD2Jabatan`', '`TTD2Jabatan`', 200, -1, FALSE, '`TTD2Jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TTD2Jabatan->Sortable = TRUE; // Allow sort
		$this->fields['TTD2Jabatan'] = &$this->TTD2Jabatan;

		// Logo
		$this->Logo = new cField('t01_sekolah', 't01_sekolah', 'x_Logo', 'Logo', '`Logo`', '`Logo`', 200, -1, FALSE, '`Logo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
