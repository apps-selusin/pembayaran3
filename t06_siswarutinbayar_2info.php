...
$t06_siswarutinbayar_2 = NULL;

//
// Table class for t06_siswarutinbayar_2
//
class ct06_siswarutinbayar_2 extends cTable {
	...
	var $Siswa_Nama;
	var $rutin_id;
	var $siswarutinbayar1_id;
	var $siswarutinbayar2_id;
	var $Bayar_Tgl;
	var $Bayar_Jumlah;
	...
	function __construct() {
		...
		$this->TableVar = 't06_siswarutinbayar_2';
		$this->TableName = 't06_siswarutinbayar_2';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t06_siswarutinbayar_2`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// siswa_id
		$this->siswa_id = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_siswa_id', 'siswa_id', '`siswa_id`', '`siswa_id`', 3, -1, FALSE, '`siswa_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Siswa_Nomor_Induk
		$this->Siswa_Nomor_Induk = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_Siswa_Nomor_Induk', 'Siswa_Nomor_Induk', '(select Nomor_Induk from t03_siswa where id = siswa_id)', '(select Nomor_Induk from t03_siswa where id = siswa_id)', 200, -1, FALSE, '(select Nomor_Induk from t03_siswa where id = siswa_id)', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Siswa_Nama
		$this->Siswa_Nama = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_Siswa_Nama', 'Siswa_Nama', '(select Nama from t03_siswa where id = siswa_id)', '(select Nama from t03_siswa where id = siswa_id)', 200, -1, FALSE, '(select Nama from t03_siswa where id = siswa_id)', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rutin_id
		$this->rutin_id = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_rutin_id', 'rutin_id', '`rutin_id`', '`rutin_id`', 3, -1, FALSE, '`rutin_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// siswarutinbayar1_id
		$this->siswarutinbayar1_id = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_siswarutinbayar1_id', 'siswarutinbayar1_id', '`siswarutinbayar1_id`', '`siswarutinbayar1_id`', 3, -1, FALSE, '`siswarutinbayar1_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->siswarutinbayar1_id->Sortable = TRUE; // Allow sort
		$this->siswarutinbayar1_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->siswarutinbayar1_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->siswarutinbayar1_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['siswarutinbayar1_id'] = &$this->siswarutinbayar1_id;

		// siswarutinbayar2_id
		$this->siswarutinbayar2_id = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_siswarutinbayar2_id', 'siswarutinbayar2_id', '`siswarutinbayar2_id`', '`siswarutinbayar2_id`', 3, -1, FALSE, '`siswarutinbayar2_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->siswarutinbayar2_id->Sortable = TRUE; // Allow sort
		$this->siswarutinbayar2_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->siswarutinbayar2_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->siswarutinbayar2_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['siswarutinbayar2_id'] = &$this->siswarutinbayar2_id;
		...
		// Bayar_Jumlah
		$this->Bayar_Jumlah = new cField('t06_siswarutinbayar_2', 't06_siswarutinbayar_2', 'x_Bayar_Jumlah', 'Bayar_Jumlah', '`Bayar_Jumlah`', '`Bayar_Jumlah`', 4, -1, FALSE, '`Bayar_Jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t06_siswarutinbayar_2`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t06_siswarutinbayar_2list.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t06_siswarutinbayar_2view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t06_siswarutinbayar_2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t06_siswarutinbayar_2add.php?" . $this->UrlParm($parm);
		else
			$url = "t06_siswarutinbayar_2add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t06_siswarutinbayar_2edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t06_siswarutinbayar_2add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t06_siswarutinbayar_2delete.php", $this->UrlParm());
	}
   ...
   // Common render codes
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->siswarutinbayar1_id->Exportable) $Doc->ExportCaption($this->siswarutinbayar1_id);
					if ($this->siswarutinbayar2_id->Exportable) $Doc->ExportCaption($this->siswarutinbayar2_id);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->siswarutinbayar1_id->Exportable) $Doc->ExportField($this->siswarutinbayar1_id);
						if ($this->siswarutinbayar2_id->Exportable) $Doc->ExportField($this->siswarutinbayar2_id);
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		if (is_null($rsold["siswarutinbayar1_id"]) and is_null($rsnew["siswarutinbayar1_id"] == null)) {
			$this->setFailureMessage("Periode pertama harus terisi !");
			return false;
		}
		if (is_null($rsold["siswarutinbayar2_id"]) and is_null($rsnew["siswarutinbayar2_id"] == null)) {
			$this->setFailureMessage("Periode kedua harus terisi !");
			return false;
		}
		if ($rsnew["siswarutinbayar2_id"] < $rsnew["siswarutinbayar1_id"]) {
			$this->setFailureMessage("Periode kedua harus lebih besar atau sama dengan Periode pertama !");
			return false;
		}
		return true;
	}
	...
	function Row_Updated($rsold, &$rsnew) {
		...
		//echo "Row Updated";
		for ($i = $rsnew["siswarutinbayar1_id"]; $i <= $rsnew["siswarutinbayar2_id"]; $i++) {
			$q = "update t06_siswarutinbayar set Bayar_Tgl = '".date("Y-m-d")."'
				where id = ".$i."
			";
			ew_Execute($q);
		}
		$q = "update t06_siswarutinbayar_2 set siswarutinbayar1_id = null,
			siswarutinbayar2_id = null where id = ".$rsold["id"].""; //echo $q;
		ew_Execute($q);
	}
